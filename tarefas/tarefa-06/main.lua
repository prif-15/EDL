...
-- tarefa - 06 	--> Tipo de dado ARRAY na variavel "constantes_limiteCaminhoEstados". As variaveis dentro do array são incluidas em ordem numerica 	e os 
				-- elementos sao identificados pela posicao dentro do array (durante a execucao do codigo).
...
function carregarJogo()
	...
	-- tarefa - 06 	--> Tipo de dado LISTA nas variaveis "canhoes", "tiros", "inimigos". 
		--	Essas variaveis guardam os registros novoCanhao, novoTiro e novoInimigo, que sao retirados fora de ordem dessas listas
