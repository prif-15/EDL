...
constante_limiteCaminhoEstado1 = {baixo = { x = 175, y = 180}, cima = {x = 265, y = 95} , multiplicadorDeDirecaoDoEstado = 1} -- vertices da primeira reta
constante_limiteCaminhoEstado2 = {baixo = { x = 175, y = 450}, cima = {x = 265, y = 360}, multiplicadorDeDirecaoDoEstado = 1 } -- vertices da segunda reta
constante_limiteCaminhoEstado3 = {baixo = { x = 635, y = 450}, cima = {x = 540, y = 360}, multiplicadorDeDirecaoDoEstado = 1 } -- vertices da terceira reta
constante_limiteCaminhoEstado4 = {baixo = { x = 635, y = 190}, cima = {x = 540, y = 100}, multiplicadorDeDirecaoDoEstado = -1 } -- vertices da quarta reta
constante_limiteCaminhoEstado5 = {baixo = { x = 810, y = 190}, cima = {x = 810 , y = 100}, multiplicadorDeDirecaoDoEstado = 1 } -- vertices do fim do caminho
...
function carregarJogo()
	...
	canhoes = {} -- arnazeba tds os canhoes ativos
	tiros = {} -- armazena todos os tiros ativos
	inimigos = {} -- arnazeba todos os inimigos ativos
end
...
function caminharInimigo(inimigo, dt)
	...
	if inimigo.estadoCaminho % 2 == 0 then
		posicaoFinal = (constantes_limiteCaminhoEstados[inimigo.estadoCaminho].baixo.y + constantes_limiteCaminhoEstados[inimigo.estadoCaminho].cima.y) / 2
		...
		posicaoFinal = (constantes_limiteCaminhoEstados[inimigo.estadoCaminho].baixo.x + constantes_limiteCaminhoEstados[inimigo.estadoCaminho].cima.x) / 2
